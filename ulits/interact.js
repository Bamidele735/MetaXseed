...
export const publicMint = async (mintAmount) => {
  ...
  try {
    ...
    return {
      success: true,
      status: (
        <a className='px' href={`https://explorer.xseedscan.io/tx/${txHash}`} target="_blank">
          <p>✅ Check out your transaction on xseedscan:</p>
          <p>{`https://explorer.xseedscan.io/tx/${txHash}`}</p>
        </a>
      )
    }
  } catch (error) {
...
export const whitelistedMint = async (mintAmount) => {
  ...
  try {
    ...
    return {
      success: true,
      status: (
        <a href={`https://explorer.xseedscan.io/address/${txHash}`} target="_blank">
          <p>✅ Check out your transaction on xseedscan:</p>
          <p>{`https://explorer.xseedscan.io/address/${txHash}`}</p>
        </a>
      )
    }
  } catch (error) {
